...
def find_stepsize_approx_exact_3(T, beta, x, pose_body, direction, curval, bm, xyzKinect, Indices):
    #x must be a column vector, is reshaped into row to go into smpl scripts
    #x is my variable beta, but beta is already used 
    #print("in step fcn")
    t = T
...
def find_stepsize_approx_exact_4(T, beta, betas, x, direction, curval, bm, xyzKinect, Indices):
    #x must be a column vector, is reshaped into row to go into smpl scripts
    #x is my variable beta, but beta is already used 
    #print("in step fcn")
    t = T
